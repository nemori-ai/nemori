...
class NemoriExperiment:
    ...
    async def setup_storage_and_retrieval(self, emb_api_key="", emb_base_url="", embed_model=""):
        ...
        discovery_engine = ContextAwareSemanticDiscoveryEngine(self.llm_provider, self.unified_retrieval_service)  # Added semantic discovery
        semantic_manager = SemanticEvolutionManager(self.semantic_repo, discovery_engine, self.unified_retrieval_service)  # Added semantic evolution
        ...
        print(f"   🧠 Semantic Discovery Engine: {type(discovery_engine).__name__}")
        print(f"   🔄 Semantic Evolution Manager: {type(semantic_manager).__name__}")
