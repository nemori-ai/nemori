...
export EVAL_VERSION="episode_semantic"
...
echo "--> 正在运行 Eval 脚本..."
python scripts/locomo/locomo_eval.py --lib nemori --quick --workers 100 --version $EVAL_VERSION > "${LOG_DIR}/eval_${TIMESTAMP}.log" 2>&1
