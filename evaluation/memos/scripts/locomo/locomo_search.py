...
async def process_user_nemori(group_idx, locomo_df, frame, version, top_k=20):
    ...
    if version == "episode_semantic":
        ...
        db_path = "evaluation/results/locomo/nemori-default/storages/nemori_memory.duckdb"
    ...
    unified_retrieval, retrieval_service, episode_repo, semantic_repo = await get_nemori_unified_client(
        ...
        emb_base_url=os.getenv('OPENAI_BASE_URL'), 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--workers", type=int, default=50, help="Number of parallel workers to process users")
    parser.add_argument("--top_k", type=int, default=10, help="Number of results to retrieve in search queries")
