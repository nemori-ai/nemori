...
async def process_single_group(group_id, group_responses, oai_client, options, num_runs):
    try:
        ...
        result = await process_group_responses(group_id, group_responses, oai_client, options, num_runs)
        end_time = time.time()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--workers", type=int, default=4, help="Number of concurrent workers for processing groups")
