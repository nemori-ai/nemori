...
async def run_semantic_memory_demo():
    ...
    try:
        ...
        print(f"🧠 发现的语义知识 | Discovered Semantic Knowledge: {episode_1.metadata.custom_fields.get('discovered_semantics', 0)} pieces")
        ...
        messages_2 = [
            ...
            ConversationMessage(
                speaker_id="John",
                content="不仅要处理文本，还要整合视觉和语音",
                timestamp=datetime(2024, 3, 20, 14, 2)
            )
        ]
